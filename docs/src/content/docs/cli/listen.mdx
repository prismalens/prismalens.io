...
exactly what you want woken for; operator-cancelled runs don't. Delivery is
best-effort with a short timeout and no retries, and a failed post can never
change a run's outcome. Leave the field unset and nothing is sent.
