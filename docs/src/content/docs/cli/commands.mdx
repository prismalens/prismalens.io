...
| LLM credential | Hard | Any one supported LLM credential env var is set — or, for `claude-code`, a signed-in `~/.claude/.credentials.json`. The canonical list lives in [Providers → Checking your setup](/cli/providers/#checking-your-setup). |
